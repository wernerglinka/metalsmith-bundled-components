...
describe( 'Utils - Options', () => {
  it( 'should export defaults', () => {
    ...
    assert.strictEqual( defaults.mainCSSEntry, 'lib/assets/main.css' );
    assert.strictEqual( defaults.mainJSEntry, 'lib/assets/main.js' );
  ...
  it( 'should merge custom options with defaults', () => {
    ...
    assert.strictEqual( result.mainCSSEntry, defaults.mainCSSEntry );
    assert.strictEqual( result.mainJSEntry, defaults.mainJSEntry );
  } );
