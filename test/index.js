...
describe('metalsmith-bundled-components', () => {
  ...
  it('should bundle JavaScript files with ES module imports', (done) => {
    ...
    ms.build((err) => {
      ...
      assert(
        jsContent.includes('Gallery') || jsContent.includes('gallery'),
        'JS should contain Gallery component code'
      );
      assert(
        jsContent.includes('trapFocus') || jsContent.includes('trap'),
        'JS should contain imported utility functions'
      );
      assert(
        jsContent.includes('preloadImage') || jsContent.includes('preload'),
        'JS should contain gallery utility functions'
      );
